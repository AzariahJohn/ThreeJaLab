...
export default function Model(props) {
  ...
  return (
    <>
    <group {...props} dispose={null} position={[0.5, 1.6, -3]} scale={1} ref={virusRef} onClick={(e) => {setRotate(!rotate)}}>
      {rna && <mesh
        castShadow
        receiveShadow
    ...
    {menu && <group position={[3.5, 1.38, -1.3]} scale={0.4} rotation={[0, -Math.PI * 0.5, 0]}>
            ...
            {rnai && <group position={[3.5, 1.38, -1.3]} scale={0.4} rotation={[0, -Math.PI * 0.5, 0]}>
        ...
        {eproi && <group position={[3.5, 1.38, -1.3]} scale={0.4} rotation={[0, -Math.PI * 0.5, 0]}>
        ...
        {evRighti && <group position={[3.5, 1.38, -1.3]} scale={0.4} rotation={[0, -Math.PI * 0.5, 0]}>
        ...
        {spikei && <group position={[3.5, 1.38, -1.3]} scale={0.4} rotation={[0, -Math.PI * 0.5, 0]}>
        ...
        {mproi && <group position={[3.5, 1.38, -1.3]} scale={0.4} rotation={[0, -Math.PI * 0.5, 0]}>
        ...
        {hemai && <group position={[3.5, 1.38, -1.3]} scale={0.4} rotation={[0, -Math.PI * 0.5, 0]}>
