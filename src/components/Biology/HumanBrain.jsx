    ...
    <>
        ...
        {six && <group position={[2, 0, 0]} rotation={[0, -Math.PI * 0.25, 0]}>
            ...
            <group position={[0.25, -0.5, 0]}>
                <Text position={[2.9, 3.0, 0.01]} fontSize={0.4}>Paretial Lobe</Text>
        ...
        {five && <group position={[2, 0, 0]} rotation={[0, -Math.PI * 0.25, 0]}>
            ...
            <group position={[0.25, -0.5, 0]}>
                <Text position={[2.9, 3.0, 0.01]} fontSize={0.4}>Occipital Lobe</Text>
                <Text position={[2.9, 2.2, 0.01]} fontSize={0.2}>Your brain's parietal lobe is a key </Text>
                <Text position={[2.9, 2.0, 0.01]} fontSize={0.2}>part of your understanding of </Text>
                <Text position={[2.9, 1.8, 0.01]} fontSize={0.2}>the world around you. It processes </Text>
                <Text position={[2.9, 1.6, 0.01]} fontSize={0.2}>your sense of touch and assembles</Text>
        ...
        {four && <group position={[2, 0, 0]} rotation={[0, -Math.PI * 0.25, 0]}>
            ...
            <group position={[0.25, -0.5, 0]}>
                <Text position={[2.9, 3.0, 0.01]} fontSize={0.4}>Friontal Lobe</Text>
                <Text position={[2.9, 2.2, 0.01]} fontSize={0.2}>Your brain's parietal lobe is a key </Text>
                <Text position={[2.9, 2.0, 0.01]} fontSize={0.2}>part of your understanding of </Text>
                <Text position={[2.9, 1.8, 0.01]} fontSize={0.2}>the world around you. It processes </Text>
                <Text position={[2.9, 1.6, 0.01]} fontSize={0.2}>your sense of touch and assembles</Text>
        ...
        {three && <group position={[2, 0, 0]} rotation={[0, -Math.PI * 0.25, 0]}>
            ...
            <group position={[0.25, -0.5, 0]}>
                <Text position={[2.9, 3.0, 0.01]} fontSize={0.4}>Temporal Lobe</Text>
                <Text position={[2.9, 2.2, 0.01]} fontSize={0.2}>Your brain's parietal lobe is a key </Text>
                <Text position={[2.9, 2.0, 0.01]} fontSize={0.2}>part of your understanding of </Text>
                <Text position={[2.9, 1.8, 0.01]} fontSize={0.2}>the world around you. It processes </Text>
                <Text position={[2.9, 1.6, 0.01]} fontSize={0.2}>your sense of touch and assembles</Text>
        ...
        {two && <group position={[2, 0, 0]} rotation={[0, -Math.PI * 0.25, 0]}>
            ...
            <group position={[0.25, -0.5, 0]}>
                <Text position={[2.9, 3.0, 0.01]} fontSize={0.4}>Spinal Cord</Text>
                <Text position={[2.9, 2.2, 0.01]} fontSize={0.2}>Your brain's parietal lobe is a key </Text>
                <Text position={[2.9, 2.0, 0.01]} fontSize={0.2}>part of your understanding of </Text>
                <Text position={[2.9, 1.8, 0.01]} fontSize={0.2}>the world around you. It processes </Text>
                <Text position={[2.9, 1.6, 0.01]} fontSize={0.2}>your sense of touch and assembles</Text>
        ...
        {one && <group position={[2, 0, 0]} rotation={[0, -Math.PI * 0.25, 0]}>
            ...
            <group position={[0.25, -0.5, 0]}>
                <Text position={[2.9, 3.0, 0.01]} fontSize={0.4}>Cerebellum</Text>
                <Text position={[2.9, 2.2, 0.01]} fontSize={0.2}>Your brain's parietal lobe is a key </Text>
                <Text position={[2.9, 2.0, 0.01]} fontSize={0.2}>part of your understanding of </Text>
                <Text position={[2.9, 1.8, 0.01]} fontSize={0.2}>the world around you. It processes </Text>
                <Text position={[2.9, 1.6, 0.01]} fontSize={0.2}>your sense of touch and assembles</Text>
